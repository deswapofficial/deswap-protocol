...
contract DWAPstaking100Days is Ownable {
    ...
    // reward rate 22.0% per 100 days
    uint256 public constant rewardRate = 2200;
    uint256 public constant rewardInterval = 100 days;
